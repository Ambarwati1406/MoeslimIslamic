...
public class JadwalSholat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAshar = (TextView)findViewById(R.id.tv_ashar);
    ...
    private void loadKota() {
        try {
            String api = "/kota";
            ClientAsyncTaskJadwal taskJadwal = new ClientAsyncTaskJadwal(this, api, new ClientAsyncTaskJadwal.OnPostExecuteListener() {
                @Override
    ...
    private void loadJadwal(int id) {
        try {
            ...
            ClientAsyncTaskJadwal taskJadwal = new ClientAsyncTaskJadwal(this, api_url, new ClientAsyncTaskJadwal.OnPostExecuteListener() {
                @Override
                public void onPostExecute(String result) {
