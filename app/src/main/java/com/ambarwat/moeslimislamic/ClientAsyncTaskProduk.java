...
public class ClientAsyncTaskProduk extends AsyncTask<Void, Void, String> {
    private final int CONNECTION_TIMEOUT_MILLISECONDS = 60000;
    private OnPostExecuteListener mPostExecuteListener = null;
    private Context mContext;
    private ProgressBar mProgress;

    //s sesuaikan ulr server api nya.
    ...
    public ClientAsyncTaskProduk(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener) {
