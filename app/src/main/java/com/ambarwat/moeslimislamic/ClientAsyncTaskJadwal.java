...
public class ClientAsyncTaskJadwal extends AsyncTask<Void, Void, String> {
    ...
    public ClientAsyncTaskJadwal(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            String inString = steamToString(urlConnection.getInputStream());
            return inString;
